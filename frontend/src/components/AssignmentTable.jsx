    ...
    <div className="bg-white dark:bg-slate-800 rounded-lg shadow">
      ...
      <div className="px-6 py-4 border-b border-gray-200 dark:border-slate-700">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
          <h3 className="text-lg font-medium text-gray-900 dark:text-slate-100 mb-4 sm:mb-0">
        ...
        <div className="mt-4 flex flex-col sm:flex-row sm:items-center space-y-3 sm:space-y-0 sm:space-x-4">
          ...
          <div className="relative flex-1">
            ...
            <input
              ...
              className="block w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-slate-600 rounded-md leading-5 bg-white dark:bg-slate-700 text-gray-900 dark:text-slate-100 placeholder-gray-500 dark:placeholder-slate-400 focus:outline-none focus:placeholder-gray-400 dark:focus:placeholder-slate-500 focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500"
            />
          </div>
          ...
          <div className="relative">
            <select
              ...
              className="block w-full pl-3 pr-10 py-2 text-base border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-gray-900 dark:text-slate-100 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 rounded-md"
            >
          ...
          <thead className="bg-gray-50 dark:bg-slate-700">
            <tr>
              ...
              <th
                ...
                className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-slate-300 uppercase tracking-wider cursor-pointer hover:text-gray-700 dark:hover:text-slate-100"
              >
                ...
                return (
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    {assignment.status === 'acknowledged' && assignment.has_acknowledgment && isExpanded && (
                      <tr key={`${assignment.id}-audit`} className="bg-gray-50 dark:bg-slate-700">
                        <td colSpan={10} className="px-6 py-4">
                          <div className="border-l-4 border-green-500 bg-white dark:bg-slate-800 p-4 rounded-r-lg shadow-sm">
                            <div className="flex justify-between items-start mb-4">
                              <h4 className="text-sm font-semibold text-gray-900 dark:text-slate-100">Acknowledgment Audit Trail</h4>
                              <button
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 text-sm">
                              <div>
                                <span className="font-medium text-gray-700 dark:text-slate-300">Acknowledged At:</span>
                                <div className="text-gray-900 dark:text-slate-100 mt-1">
                                  {formatDate(assignment.ack_created_at)}
                                  <div className="text-xs text-gray-500 dark:text-slate-400">{formatRelativeTime(assignment.ack_created_at)}</div>
                                </div>
                              </div>
                              <div>
                                <span className="font-medium text-gray-700 dark:text-slate-300">Method:</span>
                                <div className="text-gray-900 dark:text-slate-100 mt-1">
                              ...
                              <div>
                                <span className="font-medium text-gray-700 dark:text-slate-300">Policy Version:</span>
                                <div className="text-gray-900 dark:text-slate-100 mt-1">v{assignment.ack_policy_version}</div>
                              </div>
                              <div>
                                <span className="font-medium text-gray-700 dark:text-slate-300">IP Address:</span>
                                <div className="text-gray-900 dark:text-slate-100 mt-1 font-mono text-xs">{assignment.ack_ip_address || 'N/A'}</div>
                              </div>
                              {assignment.ack_typed_signature && (
                                <div className="md:col-span-2">
                                  <span className="font-medium text-gray-700 dark:text-slate-300">Typed Signature:</span>
                                  <div className="text-gray-900 dark:text-slate-100 mt-1 font-serif italic">&quot;{assignment.ack_typed_signature}&quot;</div>
                                </div>
                              )}
                              <div className="lg:col-span-3">
                                <span className="font-medium text-gray-700 dark:text-slate-300">Policy Hash (Cryptographic Verification):</span>
                                <div className="text-gray-900 dark:text-slate-100 mt-1 font-mono text-xs break-all bg-gray-100 dark:bg-slate-900 p-2 rounded">
                                  {assignment.ack_policy_hash}
                                </div>
                              </div>
                            </div>
                            <div className="mt-4 text-xs text-gray-500 dark:text-slate-400 border-t dark:border-slate-600 pt-3">
