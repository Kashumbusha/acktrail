        ...
        <div className="container-page py-10">
          <div className="grid gap-8 md:grid-cols-3 md:gap-4">
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="text-slate-400 text-sm">
                Stop chasing policy signatures. Track acknowledgments automatically.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="flex gap-4">
                <a
                  href="https://www.linkedin.com/company/acktrail/"
                  target="_blank"
                ...
                <a
                  href="https://www.instagram.com/acktrail/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-slate-400 hover:text-white transition-colors"
                ...
                <a
                  href="https://tiktok.com/@acktrail"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-slate-400 hover:text-white transition-colors"
                  aria-label="TikTok"
          ...
          <div className="mt-8 pt-8 border-t border-slate-800">
            <p className="text-slate-400 text-xs text-center">
              © 2025 AckTrail. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
