    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 to-slate-800 p-6">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {/* Total Policies */}
          <div className="relative bg-slate-800 rounded-xl p-6 border border-slate-700 hover:border-violet-500 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-violet-500/10 overflow-hidden group">
            ...
            <div className="flex justify-between items-start mb-4">
              ...
              <span className="text-xs font-semibold text-slate-400 uppercase tracking-wider">Total Policies</span>
            </div>
            <div className="text-4xl font-bold text-slate-100 mb-2">{total_policies}</div>
          ...
          {/* Acknowledged */}
          <div className="relative bg-slate-800 rounded-xl p-6 border border-slate-700 hover:border-emerald-500 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-emerald-500/10 overflow-hidden group">
            ...
            <div className="text-4xl font-bold text-slate-100 mb-2">
              {acknowledged_assignments} <span className="text-xl text-slate-500">/ {total_assignments}</span>
            </div>
          ...
          {/* Pending */}
          <div className="relative bg-slate-800 rounded-xl p-6 border border-slate-700 hover:border-amber-500 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-amber-500/10 overflow-hidden group">
            ...
            <div className="text-4xl font-bold text-slate-100 mb-2">{pending_assignments}</div>
            <div className="flex items-center gap-1 text-sm text-slate-400">
              <span>→</span>
          ...
          {/* Overdue */}
          <div className="relative bg-slate-800 rounded-xl p-6 border border-slate-700 hover:border-red-500 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-red-500/10 overflow-hidden group">
            ...
            <div className="text-4xl font-bold text-slate-100 mb-2">{overdue_assignments}</div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
          ...
          <div className="lg:col-span-2 bg-slate-800 rounded-xl p-6 border border-slate-700">
            ...
            <div className="h-48 bg-slate-900 rounded-lg flex items-center justify-center border-2 border-dashed border-slate-700">
            ...
            {recentActivity && recentActivity.length > 0 ? (
              <div className="space-y-4">
                {recentActivity.slice(0, 5).map((activity, idx) => (
                  <div key={idx} className="flex gap-3 p-3 bg-slate-900 rounded-lg hover:bg-slate-900/70 transition-colors">
        ...
        {/* Quick Actions */}
        <div className="bg-slate-800 rounded-xl p-6 border border-slate-700">
          <h3 className="text-lg font-semibold text-slate-100 mb-5">Quick Actions</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            >
              ...
              <div className="text-sm font-semibold text-slate-100 mb-1">Create Policy</div>
              <div className="text-xs text-slate-400">Add a new policy document</div>
            </Link>
            ...
            >
              <div className="text-3xl mb-3">👥</div>
              <div className="text-sm font-semibold text-slate-100 mb-1">Manage Users</div>
              <div className="text-xs text-slate-400">Add or edit team members</div>
            </Link>
            ...
            >
              <div className="text-3xl mb-3">📊</div>
              <div className="text-sm font-semibold text-slate-100 mb-1">View Reports</div>
              <div className="text-xs text-slate-400">Export compliance reports</div>
            </Link>
            ...
            >
              ...
              <div className="text-sm font-semibold text-slate-100 mb-1">Settings</div>
              <div className="text-xs text-slate-400">Configure your workspace</div>
            </Link>
          </div>
        </div>
        ...
        {seat_capacity && (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
            {/* Team Usage */}
            <div className="bg-slate-800 rounded-xl p-6 border border-slate-700">
              <h3 className="text-lg font-semibold text-slate-100 mb-5">Team Usage</h3>
              <div className="flex justify-between mb-6">
                <div>
                  <div className="text-xs text-slate-400 mb-2">Employee Seats</div>
                  <div className="text-2xl font-bold text-slate-100">
                    {seat_usage} <span className="text-lg text-slate-500">/ {seat_capacity}</span>
                  </div>
                  <div className="text-xs text-emerald-400 mt-1">{seat_available} available seats</div>
                </div>
                {admin_count !== null && admin_limit !== null && (
                  <div>
                    <div className="text-xs text-slate-400 mb-2">Admins</div>
                    <div className="text-2xl font-bold text-slate-100">
                      {admin_count} <span className="text-lg text-slate-500">/ {admin_limit}</span>
                    </div>
                    <div className="text-xs text-slate-400 mt-1">Not billed</div>
                  </div>
                )}
              </div>
              <Link
            ...
            {/* Security & Access */}
            <div className="bg-slate-800 rounded-xl p-6 border border-slate-700">
              <h3 className="text-lg font-semibold text-slate-100 mb-5">Security & Access</h3>
              <div className="flex justify-between items-center p-4 bg-slate-900 rounded-lg mb-4">
                <div>
                  <div className="text-sm font-semibold text-slate-100 mb-1">SSO Status</div>
                  <div className="text-xs text-slate-400">Single Sign-On</div>
                </div>
        ...
        {recent_policies && recent_policies.length > 0 && (
          <div className="bg-slate-800 rounded-xl border border-slate-700">
            <div className="px-6 py-4 border-b border-slate-700">
              <div className="flex justify-between items-center">
                <h3 className="text-lg font-semibold text-slate-100">Recent Policies</h3>
                <Link
                  to="/policies"
